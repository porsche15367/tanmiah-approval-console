        ...
        <div className="dropdown-wrap" ref={profileRef}>
          ...
          {profileOpen && (
            <div className="dropdown-panel narrow">
              <div className="profile-menu-item" onClick={() => { setProfileOpen(false); navigate('/profile'); }}><User size={15} /> My Profile</div>
              <div className="profile-menu-item danger" onClick={logout}><LogOut size={15} /> Logout</div>
            </div>
          )}
        </div>
      </div>
